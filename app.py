...
app.layout = html.Div(
    ...
    children=[
        ...
        html.P(
            "This map shows the locations where the incidents in the data have occured"
            " It can include TCCE (Terrosism, Communalism, Cybersecurity and Espionage) and non TCCE incidents. "
